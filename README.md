...
A funcionalidade demonstrara é o uso do docker para container da aplicação PHP/Laravel. 
...
Utilize os arquivos **DockerFile-VersaoXXX-PortaXXX-<Banco>.dockerfile** como template para a criação do arquivo **dockerfile**.